...
import { generateReportCardHtml, getPrincipalComment as getComment, getBehavioralInterpretationText } from "@/lib/report-card-template";
...
export default function StudentDashboard() {
  ...
  const generateReportHtml = (): string | null => {
    ...
    const principalComment = getComment(averagePercentage);
    ...
    return generateReportCardHtml({
      ...
      className: selectedClassObj?.name || profile.class?.name || '',
      gender: profile.gender || 'N/A',
      ageDisplay,
      term: selectedTerm,
      session: selectedSession,
      nextTermDate: publishedScoreInfo?.nextTermResumes || null,
      logoUrl: school?.logoUrl || currentLogoUrl || null,
      subjects: subjectRows,
      attendanceDays: (attendanceData && attendanceData.totalDays > 0)
        ? { total: attendanceData.totalDays, present: attendanceData.presentDays }
        : null,
