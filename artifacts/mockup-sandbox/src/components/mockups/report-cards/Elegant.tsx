  ...
  return (
    <>
      ...
      <div className="elegant-container min-h-screen py-8 px-4 flex justify-center items-start overflow-y-auto">
        <div className="w-full max-w-[800px] bg-[#fdfbf7] shadow-xl border border-[#c7d2fe] relative pb-12">
          ...
          <div className="px-10 py-8">
            ...
            {/* Student Info */}
            <section className="mb-8 p-6 bg-[#f0f4ff] border border-[#d4af37] rounded-sm">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-y-4 gap-x-8 text-sm">
                <div>
                  <span className="block text-xs uppercase tracking-wider text-[#1e3a8a] font-semibold mb-1">Student Name</span>
            ...
            <section className="mb-8">
              <h3 className="font-playfair text-xl font-bold text-[#1e3a8a] border-b-2 border-[#1e3a8a] pb-2 mb-4 uppercase tracking-widest">Academic Performance</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm border-collapse">
                  <thead>
                    <tr className="text-white" style={{ background: 'linear-gradient(to right, #1e3a8a, #1d4ed8, #1e3a8a)' }}>
                      <th className="py-3 px-4 text-left font-semibold uppercase tracking-wider text-xs border border-[#1e3a8a]">Subject</th>
                      <th className="py-3 px-2 text-center font-semibold uppercase tracking-wider text-xs border border-[#1e3a8a]">1st CA<br/><span className="text-[10px] font-normal opacity-80">(20)</span></th>
                      <th className="py-3 px-2 text-center font-semibold uppercase tracking-wider text-xs border border-[#1e3a8a]">2nd CA<br/><span className="text-[10px] font-normal opacity-80">(20)</span></th>
                      <th className="py-3 px-2 text-center font-semibold uppercase tracking-wider text-xs border border-[#1e3a8a]">Exam<br/><span className="text-[10px] font-normal opacity-80">(60)</span></th>
                      <th className="py-3 px-2 text-center font-semibold uppercase tracking-wider text-xs border border-[#1e3a8a] bg-[#1d4ed8]">Total<br/><span className="text-[10px] font-normal opacity-80">(100)</span></th>
                      <th className="py-3 px-2 text-center font-semibold uppercase tracking-wider text-xs border border-[#1e3a8a]">Grade</th>
                      <th className="py-3 px-4 text-left font-semibold uppercase tracking-wider text-xs border border-[#1e3a8a]">Remark</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              {/* Summary Stats */}
              <div>
                <h3 className="font-playfair text-lg font-bold text-[#1e3a8a] border-b border-[#1e3a8a] pb-1 mb-3 uppercase tracking-widest">Summary</h3>
              ...
              <div>
                <h3 className="font-playfair text-lg font-bold text-[#1e3a8a] border-b border-[#1e3a8a] pb-1 mb-3 uppercase tracking-widest">Behavioral</h3>
                <div className="bg-[#f0f4ff] p-4 rounded-sm border border-[#c7d2fe]">
            ...
            {/* Remarks & Promotion */}
            <section className="mb-8">
              <div className="border-l-4 border-[#1e3a8a] pl-4 mb-6">
                <h4 className="font-playfair font-bold text-[#1e3a8a] mb-1">Principal's Comment</h4>
              ...
              <div className="text-white p-4 text-center border-2 border-[#d4af37]" style={{ background: 'linear-gradient(to right, #1e3a8a, #1d4ed8, #1e3a8a)' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end mt-12 text-xs">
              <div className="bg-[#f0f4ff] p-3 border border-[#c7d2fe] rounded-sm">
                <h5 className="font-bold mb-2 uppercase tracking-wider text-[#1e3a8a] border-b border-[#d4af37]/50 pb-1">Grading Key</h5>
              ...
              <div className="grid grid-cols-2 gap-8 text-center pt-8">
                <div>
                  <div className="border-b border-[#1e3a8a] mb-2 h-8"></div>
                  <span className="uppercase tracking-widest text-[10px] font-bold text-[#1e3a8a]">Class Teacher</span>
                </div>
                <div>
                  <div className="border-b border-[#1e3a8a] mb-2 h-8"></div>
                  <span className="uppercase tracking-widest text-[10px] font-bold text-[#1e3a8a]">Principal</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 text-center no-print">
              <button 
                ...
                className="print-btn px-8 py-3 rounded-full font-semibold uppercase tracking-wider text-sm shadow-lg transition-all"
              >
                Print Report Card
              </button>
            </div>
