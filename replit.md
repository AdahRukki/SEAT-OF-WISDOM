...
- ✅ **Scores Page UX Improvement**: Removed duplicate "Save All Scores" button, made Excel upload work without subject selection (only class required), renamed to "Upload Multi-Subject Excel" for clarity
